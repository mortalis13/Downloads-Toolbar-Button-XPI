## Downloads Toolbar Button [Firefox Addon]

This addon adds a Downloads toolbar button which opens the downloads window.

---

To **install** the addon go to [releases](https://github.com/mortalis13/Downloads-Toolbar-Button-XPI/releases) and click on the **.xpi** file or download and drag it to the browser window.
